# Heart Disease Prediction Clinical Decision Support System (CDSS)
BMDS2003 Data Science Assignment Project

## Project Overview
Interactive Streamlit web application for heart disease prediction  using pre-trained Machine Learning models.
- Model used: Decision Tree, Random Forest, Logistic Regression
- Load pre-trained `model.pkl` 
- Predictions directly from ML model
- Interactive UI, health metric visualizations, radar charts, risk factor analysis
- Heart age estimation, lifestyle risk improvement simulation, clinical recommendations
- Downloadable patient assessment report

## Features
- Binary classification result: Yes / No 
- Risk severity visual progress bar
- Patient vs Healthy radar chart comparison
- Top 5 cardiac risk factor bar chart
- WHO standard health metric reference table
- Specialist referral guidelines & clinical health recommendations
...
2. Click commit new file then paste
